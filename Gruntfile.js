// Generated on 2015-11-01 using generator-jekyllrb 1.4.1
'use strict';
...
module.exports = function (grunt) {
  ...
  grunt.initConfig({
    ...
    watch: {
      sass: {
        files: ['<%= yeoman.app %>/assets/_scss/**/*.sass', '<%= yeoman.app %>/assets/_scss/**/*.scss'],
        tasks: ['sass:server', 'jekyll:server', 'autoprefixer:dist']
      },
      javascript: {
